...
export const translations = {
  en: {
    ...
    footer: {
      ...
      address: "No. 388, Pudong East Inner Ring Road, Changyuan, Henan, China",
  ...
  fr: {
    ...
    contact_page: {
      ...
      form: {
        name: "Comment devrions-nous vous appeler ?",
    ...
    footer: {
      ...
      services_title: "Services",
      contact_title: "Contact",
      address: "No. 388, Pudong East Inner Ring Road, Changyuan, Henan, Chine",
